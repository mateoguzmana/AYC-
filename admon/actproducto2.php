...
$query0001="SELECT* FROM Img_productos where Id = '$Id'" ;
...
$Foto				=$row0001["Foto"];
$Intro 				=$row0001["Intro"];
$Descripcion		=$row0001["Descripcion"];
$Pos				=$row0001["Pos"];
}
  ...
  <tr valign="middle" bordercolor="#FFFFFF" >
    <td height="132" align="center" bordercolor="#F2F2F2" ><br>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FBFBFB">
        <tr>
          <td height="62" valign="top"><form action="actproducto3.php" method="post" enctype="multipart/form-data" name="fcalen">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
                <td width="20%" align="right"><a href="ingproducto.php" class="Estilo93">Ingresar nuevo</a></td>
              </tr>
            </table>
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"> INFORMACION DEL ITEM<br>
                  ...
                  <tr>
                  <td width="50%" height="48"><span class="Estilo93" style="font-size:15px;">Nombre</span><br>     
                       <input type="text" name="Grupo" class="TextField22" id="Grupo" value="<?=$Nombre?>" style="width:99%">
					</td>
                    </tr>
                </table>
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="30"><span class="Estilo93" style="font-size:15px;">Foto vista previa JPG </span><br>
                        <a href="../productos/<?=$Foto2?>" target="blank" title="Ver foto"><img src="../productos/<?=$Foto?>" width="92" height="45"></a><br>
                        <input name="file1" type="file" class="TextField22" id="file1">
                        <span class="Estilo93">(450x425) px</span></td>
                    </tr>
                  </table>
                  <!--<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="30"><span class="Estilo93" style="font-size:15px;">Foto producto JPG </span><br>
                        <a href="../productos/g/<?=$Foto2?>" target="blank" title="Ver foto"><img src="../productos/g/<?=$Foto2?>" width="92" height="45"></a><br>
                        <input name="file2" type="file" class="TextField22" id="file2">
                        <span class="Estilo93">(1900x900) px</span></td>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">Intro</span><br>
                      <textarea name="Intro" rows="4" class="TextField22" id="Intro" style="width:99%"><?=$Intro?></textarea>
					<script>
			...
			CKEDITOR.replace( 'Intro', {
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">Descripción</span><br>
                      <textarea name="Descripcion" rows="4" class="TextField22" id="Descripcion" style="width:99%"><?=$Descripcion?></textarea>
				<script>
			// Replace the <textarea id="editor1"> with an CKEditor instance.
