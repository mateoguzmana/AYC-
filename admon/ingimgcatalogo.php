...
{
     if (form.file1.value == "")
  { alert("Por favor seleccione una imagen"); form.file1.focus(); return; }
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingimgcatalogo2.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%"><br>
                      <input name="Pos" type="text" class="TextField22" id="Pos" value="1" size="2" style="display:none;"></td>
                  </tr>
                </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
