...
$(document).ready(function(){ 	
  ...
  $("#response").slideUp("slow", function () {
	...
	$("#list ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			var order = $(this).sortable("serialize") + '&update=update&tabla=Img_inicio'; 
...
?>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="5%"><a href="actbanner.php?Id=<?=$Id?>" class="Estilo93">Refrescar</a></td>
        </tr>
      </table>
      <hr width="99%" size="1">
      <p> </p>
...
<?
$query0001="SELECT * FROM Img_inicio order by Pos" ;
...
<li id="arrayorder_<?php echo $Id0001 ?>">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="75%" valign="middle" bgcolor="#EFEFEF"><span class="Estilo93" style="font-size: 8px"><img src="../preview/<?=$Foto0001?>" width="111" height="50"><br>
          <?=$Nombre0001?></span></td>
          <td width="23%" align="center" valign="middle"><span class="Estilo93"><a href="actbanner2.php?Id=<?=$Id0001?>" target="empresa">Act</a> / <a onClick=' return confirmSubmit()' href="elibanner.php?Id=<?=$Id0001?>">Elim</a></span></td>
        </tr>
        <tr>
