...
<div id="nav_menu_wrapper">
        <div class="nav_menu">
          <table width="100%" border="0">
            <tr>
              <td width="3%">&nbsp;</td>
              <td width="72%"><object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="176" height="43">
                ...
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="botones.swf" width="176" height="43">
                  <!--<![endif]-->
                  <param name="quality" value="high" />
                  <param name="wmode" value="opaque" />
                  <param name="swfversion" value="7.0.70.0" />
              ...
              <td width="25%" align="right"><div align="center" class="Estilo96">Powered by <a href="http://www.webevolution.com.co/" target="_blank">WEB EVOLUTION</a> Copyright © 2013</div></td>
            </tr>
          </table>
<ul>
...
<table width="100%" height="57" border="0" cellpadding="0" cellspacing="0" background="Images/bg-header.jpg">
  <tr>
    ...
    <td valign="middle" background=""><img src="Images/logos.png" alt="" width="159" height="45" /></td>
