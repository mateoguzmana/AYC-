...
$query0001="SELECT* FROM Publicaciones where Id = '$Id'" ;
  ...
  <tr valign="middle" bordercolor="#FFFFFF" >
    <td height="132" align="center" bordercolor="#F2F2F2" ><br>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FBFBFB">
        <tr>
          <td height="62" valign="top"><form action="actinteres3.php" method="post" enctype="multipart/form-data" name="fcalen">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr><input type="hidden" id="Fecha" name="Fecha">
                <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
                <td width="20%" align="right"><a href="inginteres.php" class="Estilo93">Ingresar nuevo</a></td>
              </tr>
            </table>
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"> INFORMACION DEL ITEM<br>
                  ...
                  <tr>
                  <td width="50%" height="48"><span class="Estilo93" style="font-size:15px;">Titulo</span><br>     
                       <input type="text" name="Titulo" class="TextField22" id="Titulo" value="<?=$Titulo?>" style="width:99%">
					</td>
                    </tr>
                </table>
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="30"><span class="Estilo93" style="font-size:15px;">Foto vista previa JPG </span><br>
                        <a href="../publicaciones/<?=$Foto?>" target="blank" title="Ver foto"><img src="../publicaciones/<?=$Foto?>" width="92" height="45"></a><br>
                        <input name="file1" type="file" class="TextField22" id="file1">
                        <span class="Estilo93"></span></td>
                    </tr>
                  </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
