...
$query0001="SELECT * FROM Img_empresa where Id = '$Id'" ;
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actbannerempre3.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto JPG </span><br>
                      <a href="../preview/Empresa/<?=$Foto?>" target="blank"><span class="Estilo93" style="font-size: 8px"><img src="../preview/Empresa/<?=$Foto?>" width="99" height="44"></span></a> <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br>
                      <input name="file1" type="file" class="TextField22" id="file1">
                      <span class="Estilo93">(940x300) px</span></td>
                    <td width="50%">&nbsp;</td>
                  </tr>
                </table>
                <table width="100%">
                  <tr>
                    <td width="100%" height="90%"><span class="Estilo93">Titulo</span><br>
                      <input name="Titulo" type="text" class="TextField22" id="Titulo" value="<?=$Titulo?>" style="width:500px;">
                  </tr>
                 </table>
                 <table width="100%">
                  <tr>
                    <td width="100%" height="90%"><span class="Estilo93">Descripcion</span><br>
