...
function Validar(form)
{
     ...
     if (form.Grupo.value == "")
  { alert("Por favor seleccione una linea"); form.Grupo.focus(); return; }
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingarti2.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                      <td width="50%" height="48"><span class="Estilo93">Linea</span><br>
...
?>
                      ...
                      <td width="50%"><span class="Estilo93">Foto</span><br>
                        <input name="file1" type="file" class="TextField22" id="Foto" style="width:99%" ></td>
                        <input name="Pos" type="text" class="TextField22" id="Pos" style="display:none;" ></td>
                    </tr>
                </table>
                <br>
<br>
