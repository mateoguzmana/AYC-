...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actredes2.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">FACEBOOK</span><br>
                      <input name="Fb" type="text" class="TextField22" id="Fb" style="width:95%" value="<?=$Fb?>">                      <input name="Id" type="hidden" id="Id" value="<?=$Id0001?>">                      <br></td>
                    </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">INSTAGRAM</span><br>
                      <input name="It" type="text" class="TextField22" id="It" style="width:95%" value="<?=$It?>">
                      <br></td>
                  </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">GOOGLE+</span><br>
                      <input name="Go" type="text" class="TextField22" id="Go" style="width:95%" value="<?=$Go?>">
                      <br></td>
                  </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">TWITTER</span><br>
                      <input name="Tw" type="text" class="TextField22" id="Tw" style="width:95%" value="<?=$Tw?>">
                      <br></td>
                  </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><span class="Estilo93">YOUTUBE</span><br>
                      <input name="You" type="text" class="TextField22" id="You" style="width:95%" value="<?=$You?>">
                      <br></td>
                  </tr>
                </table>
                <br>
