...
?>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="5%"><a href="actalianzas.php?Id=<?=$Id?>&Nombre=<?=$Nombra?>" class="Estilo93">Refrescar</a></td>
        </tr>
      </table>
      <hr width="99%" size="1">
      <p> </p>
...
<?
$query0001="SELECT * FROM Alianzas order by Pos" ;
...
<li id="arrayorder_<?php echo $Id0001 ?>">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="75%" valign="middle" bgcolor="#EFEFEF"><img src="../Alianzas/<?=$Foto?>" style="width:80px;"></img></td>
          <td width="23%" align="center" valign="middle"><span class="Estilo93"><a href="actalianzas2.php?Id=<?=$Id0001?>" target="alianzas">Act</a> / <a onClick=' return confirmSubmit()' href="elialianzas.php?Id=<?=$Id0001?>">Elim</a></span></td>
        </tr>
        <tr>
