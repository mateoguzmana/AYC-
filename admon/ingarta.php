...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingarta2.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"><br>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30"><label><span class="Estilo93">Nombre de la linea</span><br>
                      <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:99%" >
                    </label>
                	</td>
                   </tr>
                   <tr>
                ...
                <br>
<br>
<input name="Submit2" type="button" onClick=Validar(this.form) class="TextField211" value="REALIZAR OPERACION" style="cursor:pointer;">
              </div></td>
            </tr>
          </table>
        </form></td>
