...
$query0001="SELECT* FROM Alianzas where Id = '$Id'" ;
              ...
              <tr>
                <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"> INFORMACION DEL ITEM<br>
                  ...
                  <td width="50%" height="48"><span class="Estilo93" style="font-size:15px;">Nombre</span><br>     
                       <input type="text" name="Nombre" class="TextField22" id="Nombre" value="<?=$Nombre?>" style="width:99%">
					</td>
                    </tr>
                </table>
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="30"><span class="Estilo93" style="font-size:15px;">Foto</span><br>
                        <a href="../Alianzas/<?=$Foto2?>" target="blank" title="Ver foto"><img src="../Alianzas/<?=$Foto?>" width="92" height="45"></a><br>
