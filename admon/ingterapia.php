...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingterapia2.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="50%"><span class="Estilo93">Subtitulo</span><br>
                      <input name="Subtitulo" type="text" class="TextField22" id="Subtitulo" style="width:99%" ></td>
                  </tr>
                  </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="50%"><span class="Estilo93">Pos</span><br>
                      <input name="Pos" type="text" class="TextField22" id="Pos" size="2"></td>
                  </tr>
              </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td colspan="2"><span class="Estilo93">Intro</span><br>
                      <textarea name="Intro" rows="3" class="TextField22" id="Intro" style="width:99%"></textarea></td>
                  </tr>
                </table>
<label><br>
              </label>
		...
		<textarea cols="100%" id="Texto" name="Texto" rows="15"></textarea>
