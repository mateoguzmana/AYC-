...
$(document).ready(function(){ 	
  ...
  $("#response").slideUp("slow", function () {
	...
	$("#list ul").sortable({ opacity: 0.8, cursor: 'move', update: function() {
			...
			var order = $(this).sortable("serialize") + '&update=update&tabla=Img_carrusel'; 
...
?>
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="95%"><div align="left" class="Estilo92 Estilo94">
            <form name="form" id="form">
              <select name="jumpMenu" class="TextField" id="jumpMenu" onChange="MM_jumpMenu('self',this,0)">
...
<option value="actarti.php" selected><?=$Nombra?></option>
<?

$query0001="SELECT * FROM Categorias where Id <> '$Id' order by Pos" ;
...
$Cod				=$row0001["Id"];
?>
                <option value="actarti.php?Id=<?=$Cod?>&Nombre=<?=$Nombre?>"><?=$Nombre?></option>
<?
}
?>
              </select>
          ...
          <td width="5%"><a href="actarti.php?Id=<?=$Id?>&Nombre=<?=$Nombra?>" class="Estilo93">Refrescar</a></td>
        </tr>
      </table>
      <hr width="99%" size="1">
      <p> </p>
...
<?
$query0001="SELECT* FROM Img_carrusel where IdLinea = '$Id' order by Pos" ;
$result0001=mysql_query($query0001, $id);
...
<li id="arrayorder_<?php echo $Id0001 ?>">
      ...
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="75%" valign="middle" bgcolor="#EFEFEF"><img src="../carrusel/<?=$Foto?>" style="width:80px;"></img></td>
          <td width="23%" align="center" valign="middle"><span class="Estilo93"><a href="actarti2.php?Id=<?=$Id0001?>" target="empresa">Act</a> / <a onClick=' return confirmSubmit()' href="eliarti.php?Id=<?=$Id0001?>">Elim</a></span></td>
        </tr>
        <tr>
