...
$query0001="SELECT * FROM Frases where Id = '1'" ;
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actfrase3.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="50"><span class="Estilo93"><h3>Frase espa&#241;ol</h3></span><br>
                      <input name="Nombre1" type="text" class="TextField22" id="Nombre1" style="width:95%" value="<?=$Nombre1?>"><br></td>
                  </tr>
                </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="50"><span class="Estilo93"><h3>Phrase english</h3></span><br>
                      <input name="Nombre2" type="text" class="TextField22" id="Nombre2" style="width:95%" value="<?=$Nombre2?>"><br></td>
                  </tr>
                </table>
                <br>
                <br>
...
<hr>
                <p><br>
                  <input name="Submit2" type="button" onClick="Validar(this.form);" class="TextField211" value="CAMBIAR FRASE">
                </p>
                <p>&nbsp;</p>
                <p>&nbsp;</p>
              </div></td>
