...
$query0001="SELECT* FROM Frases where Id = '$Id'" ;
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingfrase.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Titulo</span><br>
                      <input name="Nombre1" type="text" class="TextField22" id="Nombre1" style="width:95%" value="<?=$Nombre1?>">
                      <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br></td>
                    <td width="50%"><span class="Estilo93">Mensaje 2</span><br>
                      <input name="Nombre2" type="text" class="TextField22" id="Nombre2" style="width:100%" value="<?=$Nombre2?>"></td>
                  </tr>
                </table>
                <br>
                <br>
