...
$query0001="SELECT* FROM Img_inicio where Id = '$Id'" ;
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingbanner.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actbanner3.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto JPG</span><br>
                      <span class="Estilo93" style="font-size: 8px"><img src="../preview/<?=$Foto?>" width="104" height="44"></span> <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br>
                 ...
                 <table width="100%">
                  <tr>
                    <td width="100%" height="90%"><span class="Estilo93">Frase</span><br>
                      <input name="Texto" type="text" class="TextField22" id="Texto" value="<?=$Texto?>" style="width:500px;">
                  </tr>
                 </table>
                <br>
                <br>
