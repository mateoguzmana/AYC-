...
$query0001="SELECT* FROM Img_catalogo where Id = '$Id'" ;
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="20%" align="right"><a href="ingimgcatalogo.php" class="Estilo93">Ingresar nuevo</a></td>
  </tr>
</table>
...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="actimgcatalogo3.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto JPG</span><br>
                      <span class="Estilo93" style="font-size: 8px"><a href="../Catalogo/<?=$Foto?>" target="blank"><img src="../Catalogo/<?=$Foto?>" width="104" height="44"></a></span> <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                      <br>
                      <input name="file1" type="file" class="TextField22" id="file1">
                      <span class="Estilo93">(2000x2000) px</span></td>
