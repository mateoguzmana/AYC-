...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingalianzas2.php" method="post" enctype="multipart/form-data" name="fcalen">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                  	<td width="50%" height="48"><span class="Estilo93">Nombre</span><br>  
                       <input type="text" name="Nombre" class="TextField22" id="Nombre" style="width:99%">
					</td>
                    </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
