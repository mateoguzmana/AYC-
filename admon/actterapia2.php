...
$query0001="SELECT* FROM Terapias where Id = '$Id'" ;
  ...
  <tr valign="middle" bordercolor="#FFFFFF" >
    <td height="132" align="center" bordercolor="#F2F2F2" ><br>
      <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FBFBFB">
        <tr>
          <td height="62" valign="top"><form action="actterapia3.php" method="post" enctype="multipart/form-data" name="fcalen">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
                <td width="20%" align="right"><a href="ingterapia.php" class="Estilo93">Ingresar nuevo</a></td>
              </tr>
            </table>
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"> INFORMACION DEL ITEM
                  ...
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%"><span class="Estilo93">Nombre</span><br>
                        <input name="Nombre" type="text" class="TextField22" id="Nombre" style="width:99%" value="<?=$Nombre?>" ></td>
                      <td width="50%"><span class="Estilo93">Subtitulo</span><br>
                        <input name="Subtitulo" type="text" class="TextField22" id="Subtitulo" style="width:99%" value="<?=$Subtitulo?>" ></td>
                    </tr>
                  </table>
                  <br>
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td colspan="2"><span class="Estilo93">Intro</span><br>
                        <textarea name="Intro" rows="3" class="TextField22" id="Intro" style="width:99%"><?=$Intro?></textarea></td>
                    </tr>
                  </table>
                  <br>
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="5" valign="top"><span class="Estilo93">Descripcion</span><br>
                        <textarea cols="100%" id="Texto" name="Texto" rows="15" style="width:100%"><?=$Texto0001?></textarea>
                        <script>
                  ...
                  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="50%" height="30"><span class="Estilo93">Foto JPG </span><br>
                        <img src="../terapias/p/<?=$Foto?>" width="110" height="75"><br>
                        <input name="file1" type="file" class="TextField22" id="file1">
                        <span class="Estilo93">(320x300) px</span></td>
                      <td width="50%" valign="top"><span class="Estilo93">Pos</span><br>
                        <input name="Pos" type="text" class="TextField22" id="Pos" value="<?=$Pos0001?>" size="2"></td>
                    </tr>
                  </table>
                  <label><br>
                    <br>
