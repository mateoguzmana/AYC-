...
<table width="99%" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#996633">
  <tr valign="middle" bordercolor="#FFFFFF" bgcolor="#E6E6E6">
    <td height="132" align="center" bordercolor="#F2F2F2"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FBFBFB">
      <tr>
        <td height="62" valign="top" bgcolor="#EBEBEB"><form action="actempresa3.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="80%"><div align="left" class="Estilo92 Estilo94"></div></td>
              <td width="20%" align="right"><a href="ingempresa.php" class="Estilo93">Ingresar nuevo</a></td>
            </tr>
          </table>
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"> INFORMACION DEL ITEM<br>
                <br>
                <label>Nombre espa&#241;ol<br>
                  <input name="Nombre" type="text" class="TextField22" id="Nombre" value="<?=$Nombre?>" size="40">
                  <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                  <br>
                  <br>
                  <label>Nombre ingles<br>
                  <input name="NombreEN" type="text" class="TextField22" id="Nombre2" value="<?=$NombreEN?>" size="40">
                  <input name="Id" type="hidden" id="Id" value="<?=$Id?>">
                  <br>
                  </label>
