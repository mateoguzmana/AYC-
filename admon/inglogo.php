...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="inglogo2.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%"><br>
                      <input name="Pos" type="text" class="TextField22" id="Pos" size="2" style="display:none;" value="0"></td>
                  </tr>
                </table>
                <br>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
