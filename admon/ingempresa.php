...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingempresa2.php" method="post" enctype="multipart/form-data" name="fcalen">
            ...
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left"><br>
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="40%" height="30"><label><span class="Estilo93">Nombre espa&#241;ol</span><br>
                      <input name="Nombre" type="text" class="TextField22" id="Nombre" size="40" >
                    </label></td>
                    <td width="40%" height="30"><label><span class="Estilo93">Nombre ingles</span><br>
                      <input name="NombreEN" type="text" class="TextField22" id="NombreEN" size="40" >
                    </label></td>
                    <td width="50%"><br>
                      <input name="Pos" type="text" class="TextField22" id="Pos" size="2" value="0" style="display:none;"></td>
                  </tr>
                </table>
                <label><br>
                </label>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <br>
                    <span class="Estilo93">Contenido espa&#241;ol</span> <br>
<textarea cols="100%" id="Texto" name="Texto" rows="15" style="width:100%"><?=$Texto?>
                    </textarea>
                      <script>
			...
			CKEDITOR.replace( 'Texto', {
                ...
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="5" valign="top">
                    <br>
                    <span class="Estilo93">Contenido ingles</span> <br>
<textarea cols="100%" id="TextoEN" name="TextoEN" rows="15" style="width:100%"><?=$TextoEN?>
                    </textarea>
                      <script>
			// Replace the <textarea id="editor1"> with an CKEditor instance.
