...
?>
      ...
      <tr>
        <td height="138" valign="top"><form action="ingproducto2.php" method="post" enctype="multipart/form-data" name="fcalen">
          <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="33" valign="top" class="Estilo93 Estilo96"><div align="left">
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                  	<td width="50%" height="48"><span class="Estilo93">Nombre</span><br>  
                       <input type="text" name="Grupo" class="TextField22" id="Grupo" style="width:99%">
					</td>
                    </tr>
                </table>
                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <!--<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="50%" height="30"><span class="Estilo93">Foto producto JPG </span><br>
                      <input name="file2" type="file" class="TextField22" id="file2">
                      <span class="Estilo93">(1800X900) px</span></td>
                  </tr>
          </table>-->
		  <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
